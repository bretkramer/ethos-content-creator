...
## What This Is
A demo tool that turns a plain-text topic into a draft course — lesson cards and quiz questions sourced from Wikipedia by default — and, on request, writes that draft into a live Ethos LMS tenant as real lessons, quizzes, and users. It exists for people running sales demos, integration tests, or tenant walkthroughs who need realistic-looking course content in Ethos within minutes rather than hand-authored from scratch, and who then want to simulate learners moving through that content to show enrollment and completion flows without recruiting real users.
...
- The one GitHub Action present (`.github/workflows/notify-obsidian-hub.yml`) notifies an external "Obsidian Hub" notes/automation system on repo activity — a documentation-tooling hook, unrelated to deployment.
...
- This living-state document regenerates on a recurring, roughly weekly cadence against an otherwise static codebase — the documentation loop is currently the only visibly active process in the repository.
...
---
_Auto-generated by [obsidian-hub](https://github.com/bretkramer/ethos-obsidian-hub) · 2026-08-24_
